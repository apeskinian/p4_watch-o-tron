...
| Expectation | Test | Result | Fix | Screenshot |
| --- | --- | --- | --- | --- |
| User can click on the 'Add Watch' button and is taken to the watch input page, the form will be empty and the list preselected to match the list they were viewing. | Click on the 'Add Watch' button. | SUCCESS - user is taken to the input page to add a new watch. The form is empty and the list is preselected. | n/a | ![screenrecording](documentation/testing/manual_testing/adding_editing/wot_testing_manual_a_e_click_add.gif "watch-o-tron testing adding watches") |
