...
- #### Deleting movements and lists
    ...
    | User can cancel the list deletion by clicking on the modal cancel, the modal will close and the use will be notified of the cancellation | Click on the modal close button. | SUCCESS - the deletion was cancelled and the user was notified. | n/a | ![screenrecording](documentation/testing/manual_testing/staff_settings/wot_testing_ss_del_list_modal_close.gif "watch-o-tron testing staff settings") |
