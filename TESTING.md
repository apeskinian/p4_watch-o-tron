...
- #### Deleting movements and lists
    ...
    | User can cancel the list deletion by clicking on the modal close button, the modal will close and the use will be notified of the cancellation | Click outside of the presented modal. | SUCCESS - clicks outside of the modal were ignored. | n/a | ![screenrecording](documentation/testing/manual_testing/staff_settings/wot_testing_ss_del_list_outside.gif "watch-o-tron testing staff settings") |
